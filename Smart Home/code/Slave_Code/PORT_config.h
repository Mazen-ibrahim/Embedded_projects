...
/*
 * chosse   0 : for INPUT  ,  1 : for OUTPUT
*/
...
#define PORTB_PIN4_DIR  0              //(SS:INPUT for slave)
#define PORTB_PIN5_DIR  0              //(MOSI:Input for slave)
#define PORTB_PIN6_DIR  1              //(MISO:Output for slave)
#define PORTB_PIN7_DIR  0              //(SCK:Input for Slave)
